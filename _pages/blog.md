...
<div class="text-center mb-4">
  <strong>Sélectionnez la perspective qui vous convient</strong>
</div>

{% tabs blog-view %}

{% tab blog-view Statistiques et Santé Publique (en français) %}

### Statistiques & Santé Publique (FR)

<div class="row row-cols-1 row-cols-md-2 g-4">
  {% if santepub_posts == empty %}
    <div class="col">
  ...
  {% else %}
    {% for post in santepub_posts limit: 6 %}
...
{% tab blog-view Independent research & personal projects %}
