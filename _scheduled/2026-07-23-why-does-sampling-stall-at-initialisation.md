---
layout: post
title: "Why does sampling stall at initialisation?"
...
<!--
  ...
  NUMBERS — from outputs/blog_figures_report.txt:
    at the starting prevalence p₀ = σ(-4) = 0.018,  log P(count ≤ 10) is
  ...
  only known to ±5 — a second layer of censoring this model does not carry. It
  is the same problem as the rounded measurements in your EDF work. Include it
  or hold it for a later post, but it is an honest limitation and it is unstated
